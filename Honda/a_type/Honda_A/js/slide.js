function slider() {
  ...
  function progressbar () {
    if($('.slide_one').hasClass('active')) {
      $('#section1 .progressbar-container .progressbar .active-progressbar').css({'width': "33.3333%"});
      $('#number').text('01');
      ...
      $('#section1 .progressbar-container .progressbar .active-progressbar').css({'width': "66.6666%"});
      $('#number').text('02');
      $('.sub-title h3').removeClass('upAni1')
      ...
      $('#section1 .progressbar-container .progressbar .active-progressbar').css({'width': "100%"});
      $('#number').text('03');
      $('.sub-title h3').removeClass('upAni1')
